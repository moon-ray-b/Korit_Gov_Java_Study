...
public class StrMap {
    ...
    * */
    public static void main(String[] args) {
        ...
        strMap1.put("kor2025001", "배찬익");
        strMap1.put("kor2025002", "이찬익");
        strMap1.put("kor2025003", "이찬익");
        strMap1.put("kor2025004", "박찬익");
        strMap1.put("kor2025005", "욕찬익");
        ...
        }// Entry 는 하나한 뜯어 볼수 있다 get**(key), value**(값)


        strMap1.put("kor2025005","이동윤");
        System.out.println(strMap1);
        //Map의 특징 하나로 하나의 key에는 하나의 value만 가능
        ...
        //특정 값의 존재 여부
        boolean searchValueFlag2 = strMap1.containsValue("배찬익");
        ...
        Collections.sort(entryList, Map.Entry.comparingByValue());//키 기준 정렬
