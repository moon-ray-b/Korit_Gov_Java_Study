...
public class Operator {
    public static void main(String[] args) {
        ...
        int num1 = 10;
        /*
         * 여기서 =은 대입 연산자, 해당 변수에데이터(값)을 대입한다는 의미
         * 수학적 의미인 같다라는 의미가 X
         * */
        ...
        System.out.println(j++);//후이 연산자
        System.out.println(j);
        System.out.println(++j);//전이 연산자
        ...
        System.out.println(!flag1);//! not 부정 => 해당 조건을 반대의 결과값
        System.out.println(!flag2);//true

        System.out.println("==================================================");

        //논리 연산자 조합 (&&, ||)
        //&& => 선조건이 true일 때만 후조건을 실행하며 선조건이 false이면 후조건을 실행하지않는다.
        //|| => 선조건이 true이면 후조건을 실행하지 않으며 선조건이 false일때만 후조건을 실행한다.

        int a = 10;
        int b = 20;
        System.out.println(b > a && a > 5); //true
        ...
        String air = (height >= 120) ? "탑승 가능" : "탑승 불가능";
        ...
        * */
        ...
        /*int m = 77;
        String last = (m >=90 m >=80 m >=70 m >=60) ? "A" :"B" : "C" : "D";
        System.out.println(last);*/
        // 이코드 내가 짠건데 아님 아래처럼 해야함
