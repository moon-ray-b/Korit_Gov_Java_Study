...
public class Main {
    public static void main(String[] args) {
        ...
        //왜??
        //=> 코드의 재사용성과 계층 구조 설계를 가능하게 ㅁ해주는 학심 개념
         ...
         * 자식 클래스는 피룡한 기능을 추가로하거나, 변경(오버라이딩)도 가능
         * */

        Animal animal1 = new Animal("호랑이", 5);
        animal1.move();

        Tiger tiger = new Tiger("호랑이", 6, true);
        tiger.move();
        tiger.hunt();

//        Human human = new Human("배찬익", 23, true, "bookName");
//        human.name();
//        human.age();
//        human.move();
//        human.read();
        ...
        message.print();
        SimpleMessage simpleMessage = new SimpleMessage("심플메세지 입니다");
        simpleMessage.print();
