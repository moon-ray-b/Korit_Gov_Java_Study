...
public class Tiger extends Animal{
    ...
    // 그러므로 자식클래스에서 추가한 필드 속성도 getter/setter를 만들어 줘야한다.
    ...
    // 왜? => 자식 클래스에 맞게 다른게 동작시켜야 할 때
    //부모 클래스의 접근제어범위가 더 좁아야 한다.

    /*
    * 어노테이션(시그니처)
    * 코드에 붙이는 꼬리표
    * 비유하면 이 친구는 이런 용도로 사용되니깐 좀 특별하게 유심히 잘 봐줘
    ...
    * */
    ...
    public void move(){
        super.move();
        //부모클래스인 Animal 클래스의 move()메소드를 호출 한 것
