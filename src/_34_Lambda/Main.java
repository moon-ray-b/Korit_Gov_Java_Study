...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(comparator.compare(6, 8));


        //람다로 받을때
        Comparator<Integer> lambdaComperator = ( (o1, o2) -> o1.compareTo(02));
        System.out.println(lambdaComperator.compare(10,5));
        ...
        *
        * 람다의 단점
        * 디버깅 어려움 - 람다식 내부에서 발생하는 오류의 디버깅이 어렵다 => 간결하게  코드를 쓰기때문
        * 재사용성이 낮다 - 익명클래스에 비해서 재사용이 어려움 => 보통 한줄로 한번만 사용함
        ...
        *
        * Supplier<T> - T get();
        * 매개변수 없이 값을 반환하느 ㄴ인터페이스, 단순히 값을 '공급'하는 역할
        *
